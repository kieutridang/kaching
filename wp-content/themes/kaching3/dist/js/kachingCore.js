...
(function () {
    ...
    angular.module('kachingCore').factory('userService', ['$q', 'apiService', function ($q, apiService) {
        ...
        function getUser() {
            ...
            apiService.get('/auth/me/', false, true).then(function (response) {
        ...
        function updateUser(user) {
            ...
            apiService.patch('/auth/me/', data, true).then(function (data) {
        ...
        function registerUser(user) {
            ...
            apiService.post('/auth/register/', data, false).then(function (data) {
